    ...
    <>
      {!testMode && (
        <div className="p-3 sm:p-4 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg">
          <div className="font-medium text-yellow-800 dark:text-yellow-200 mb-2 text-sm sm:text-base">
      ...
      {/* Email Configuration Grid - Mobile Responsive */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 text-sm">
        <div>
          <div className="font-medium text-foreground text-sm sm:text-base">{t('adminEmail.configuration.implementedEmails')}</div>
          <ul className="text-gray-600 dark:text-gray-400 mt-1 space-y-1 text-xs sm:text-sm">
        ...
        <div>
          <div className="font-medium text-foreground text-sm sm:text-base">{t('adminEmail.configuration.pendingEmails')}</div>
          <ul className="text-gray-600 dark:text-gray-400 mt-1 space-y-1 text-xs sm:text-sm">
