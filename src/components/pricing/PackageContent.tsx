      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-5 lg:gap-6 max-w-7xl mx-auto">
        <Card className="border-primary/20 bg-gradient-to-br from-primary/5 to-primary/10 shadow-sm hover:shadow-md transition-shadow duration-300">
          <CardHeader className="text-center pb-3 sm:pb-4 px-3 sm:px-4 md:px-6">
            ...
            <CardTitle className="text-base sm:text-lg md:text-xl leading-tight">{t('pricing.packageContent.cards.tierTrainer.title')}</CardTitle>
          </CardHeader>
          <CardContent className="space-y-2 sm:space-y-2.5 md:space-y-3 px-3 sm:px-4 md:px-6 pb-4 sm:pb-5 md:pb-6">
            <div className="flex items-start gap-1.5 sm:gap-2">
              ...
              <span className="text-xs sm:text-sm leading-relaxed">{t('pricing.packageContent.cards.tierTrainer.feature1')}</span>
            </div>
            <div className="flex items-start gap-1.5 sm:gap-2">
              <CheckCircle className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-green-600 mt-0.5 flex-shrink-0" />
              <span className="text-xs sm:text-sm leading-relaxed">{t('pricing.packageContent.cards.tierTrainer.feature2')}</span>
            </div>
            <div className="flex items-start gap-1.5 sm:gap-2">
              <CheckCircle className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-green-600 mt-0.5 flex-shrink-0" />
              <span className="text-xs sm:text-sm leading-relaxed">{t('pricing.packageContent.cards.tierTrainer.feature3')}</span>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="border-primary/20 bg-gradient-to-br from-primary/5 to-primary/10 shadow-sm hover:shadow-md transition-shadow duration-300">
          <CardHeader className="text-center pb-3 sm:pb-4 px-3 sm:px-4 md:px-6">
            ...
            <CardTitle className="text-base sm:text-lg md:text-xl leading-tight">{t('pricing.packageContent.cards.multimodal.title')}</CardTitle>
          </CardHeader>
          <CardContent className="space-y-2 sm:space-y-2.5 md:space-y-3 px-3 sm:px-4 md:px-6 pb-4 sm:pb-5 md:pb-6">
            <div className="flex items-start gap-1.5 sm:gap-2">
              <CheckCircle className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-green-600 mt-0.5 flex-shrink-0" />
              <span className="text-xs sm:text-sm leading-relaxed">{t('pricing.packageContent.cards.multimodal.feature1')}</span>
            </div>
            <div className="flex items-start gap-1.5 sm:gap-2">
              <CheckCircle className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-green-600 mt-0.5 flex-shrink-0" />
              <span className="text-xs sm:text-sm leading-relaxed">{t('pricing.packageContent.cards.multimodal.feature2')}</span>
            </div>
            <div className="flex items-start gap-1.5 sm:gap-2">
              <CheckCircle className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-green-600 mt-0.5 flex-shrink-0" />
              <span className="text-xs sm:text-sm leading-relaxed">{t('pricing.packageContent.cards.multimodal.feature3')}</span>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="border-primary/20 bg-gradient-to-br from-primary/5 to-primary/10 shadow-sm hover:shadow-md transition-shadow duration-300">
          <CardHeader className="text-center pb-3 sm:pb-4 px-3 sm:px-4 md:px-6">
            ...
            <CardTitle className="text-base sm:text-lg md:text-xl leading-tight">{t('pricing.packageContent.cards.customized.title')}</CardTitle>
          </CardHeader>
          <CardContent className="space-y-2 sm:space-y-2.5 md:space-y-3 px-3 sm:px-4 md:px-6 pb-4 sm:pb-5 md:pb-6">
            <div className="flex items-start gap-1.5 sm:gap-2">
              <CheckCircle className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-green-600 mt-0.5 flex-shrink-0" />
              <span className="text-xs sm:text-sm leading-relaxed">{t('pricing.packageContent.cards.customized.feature1')}</span>
            </div>
            <div className="flex items-start gap-1.5 sm:gap-2">
              <CheckCircle className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-green-600 mt-0.5 flex-shrink-0" />
              <span className="text-xs sm:text-sm leading-relaxed">{t('pricing.packageContent.cards.customized.feature2')}</span>
            </div>
            <div className="flex items-start gap-1.5 sm:gap-2">
              <CheckCircle className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-green-600 mt-0.5 flex-shrink-0" />
              <span className="text-xs sm:text-sm leading-relaxed">{t('pricing.packageContent.cards.customized.feature3')}</span>
            </div>
          </CardContent>
        </Card>
      </div>
