  ...
  return (
    <Accordion type="multiple" className="w-full">
      <AccordionItem value="module-details" className="border-0">
        <AccordionTrigger className="px-4 py-3 hover:bg-gray-50 border-t">
          <span className="font-medium">📚 Modul-Details anzeigen</span>
        </AccordionTrigger>
        <AccordionContent className="px-4 pb-4">
          <div className="space-y-4">
            {/* Ziel der Übung */}
            <div className="border-l-4 border-l-blue-300 pl-4 bg-blue-50 p-4 rounded-r-lg">
            ...
            <Accordion type="multiple" className="mt-3">
              ...
              >
                <ul className="space-y-1">
                  <li className="text-red-800">❌ Kein Schimpfen oder Strafen</li>
                  <li className="text-red-800">❌ Zu schnelles Steigern der Schwierigkeit</li>
                  <li className="text-red-800">❌ Fehlende Belohnung = Übung verliert Reiz</li>
                  <li className="text-red-800">❌ Negative Verknüpfungen (Training = Zwang)</li>
                </ul>
              </DetailSection>
            </Accordion>
          </div>
