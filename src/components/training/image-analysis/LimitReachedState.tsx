...
export const LimitReachedState = ({ maxAnalyses }: LimitReachedStateProps) => {
  ...
  return (
    <div className="space-y-4">
      <div className="border-2 border-dashed border-orange-300 rounded-lg p-8 bg-orange-50">
        <Crown className="h-12 w-12 text-orange-600 mx-auto mb-4" />
        <p className="text-orange-700 font-medium mb-2">{t('imageAnalysis.limitReachedState.title')}</p>
