      ...
      <Card className="border-green-200 dark:border-green-800 bg-green-50 dark:bg-green-900/20 mb-4">
        <CardContent className="p-4">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <Badge variant="outline" className="border-green-300 dark:border-green-700 text-green-800 dark:text-green-200 bg-white dark:bg-card self-start sm:self-auto">
    ...
    return (
      <Card className="border-orange-200 dark:border-orange-800 bg-orange-50 dark:bg-orange-900/20 mb-4">
        <CardContent className="p-4 text-center">
          ...
          <h3 className="font-semibold text-orange-800 dark:text-orange-200 mb-2 px-2">
            {t('imageAnalysis.limitDisplay.limitReached.title')} ({analysesUsed}/{maxAnalyses})
          </h3>
          <p className="text-sm text-orange-700 dark:text-orange-300 mb-3 px-2">
            {t('imageAnalysis.limitDisplay.limitReached.description')}
          </p>
          <Button 
            className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 dark:from-blue-500 dark:to-purple-500 dark:hover:from-blue-600 dark:hover:to-purple-600 text-white w-full sm:w-auto"
